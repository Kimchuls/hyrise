...
class StoredTableNodeTest : public BaseTest {
 protected:
  void SetUp() override {
    ...
    table_t_a->create_index<GroupKeyIndex>({ColumnID{0}},"t_a", "i_a1");
    table_t_a->create_index<GroupKeyIndex>({ColumnID{1}},"t_a", "i_b");
    table_t_a->create_index<CompositeGroupKeyIndex>({ColumnID{0}, ColumnID{1}},"t_a", "i_a2");
    table_t_a->create_index<CompositeGroupKeyIndex>({ColumnID{1}, ColumnID{0}},"t_a", "i_a3");
