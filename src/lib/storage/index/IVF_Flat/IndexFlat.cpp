...
struct FlatIPDis : FlatCodesDistanceComputer {
    ...
    float symmetric_dis(int64_t i, int64_t j) final override {
...
struct FlatL2WithNormsDis : FlatCodesDistanceComputer {
    ...
    float operator()(const int64_t i) final override {
...
void IndexFlat1D::add(int64_t n, const float* x) {
    IndexFlatL2::add(n, x);
