...
class SQLTranslator final {
  ...
  */
  ...
  std::shared_ptr<AbstractLQPNode> _translate_create_vector_index(const hsql::CreateStatement& create_statement);
  ...
  std::shared_ptr<AbstractLQPNode> _translate_set(const hsql::SetStatement& set_statement);
