...
class LQPTranslator {
 ...
 private:
  ...
  std::shared_ptr<AbstractOperator> _translate_set_node(const std::shared_ptr<AbstractLQPNode>& node) const;
  ...
  std::shared_ptr<AbstractOperator> _translate_similar_search_node(const std::shared_ptr<AbstractLQPNode>& node) const;
  ...
  std::shared_ptr<AbstractOperator> _translate_create_vector_index_node(const std::shared_ptr<AbstractLQPNode>& node) const;
