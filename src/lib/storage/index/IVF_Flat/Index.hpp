...
struct Index {
     ...
     * @param labels      output labels of the NNs, size n*k
     */
    virtual void assign(int64_t n, const float* x, int64_t* labels, int64_t k = 1)
            const;
     ...
     */
    virtual void reconstruct(int64_t key, float* recons) const;
     ...
     */
    virtual void reconstruct_batch(int64_t n, const int64_t* keys, float* recons)
            const;
     ...
     */
    virtual void reconstruct_n(int64_t i0, int64_t ni, float* recons) const;
