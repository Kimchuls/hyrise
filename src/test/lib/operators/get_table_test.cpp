...
class OperatorsGetTableTest : public BaseTest {
 protected:
  void SetUp() override {
    ...
    table->create_index<GroupKeyIndex>({ColumnID{0}}, "int_int_float","i_a");
    table->create_index<GroupKeyIndex>({ColumnID{1}}, "int_int_float","i_b1");
    table->create_index<GroupKeyIndex>({ColumnID{1}}, "int_int_float","i_b2");
  }
};
