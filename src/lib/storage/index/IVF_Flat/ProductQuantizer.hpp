...
#ifndef VINDEX_PRODUCT_QUANTIZER_H
#define VINDEX_PRODUCT_QUANTIZER_H
...
VINDEX_API extern int product_quantizer_compute_codes_bs;
...
#include "ProductQuantizer-inl.hpp"
