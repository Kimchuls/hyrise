...
#ifndef VINDEX_INDEX_PQ_H
#define VINDEX_INDEX_PQ_H
...
struct IndexPQ : IndexFlatCodes {
     ...
     */
    void hamming_distance_table(int64_t n, const float* x, int32_t* dis) const;
};
...
VINDEX_API extern IndexPQStats indexPQ_stats;
...
VINDEX_API extern int multi_index_quantizer_search_bs;
